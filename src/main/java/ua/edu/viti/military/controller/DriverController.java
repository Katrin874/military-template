...
import ua.edu.viti.military.dto.request.DriverUpdateDTO; // <--- ЦЕЙ ІМПОРТ ВАЖЛИВИЙ
...
public class DriverController {
    ...
    @GetMapping
    @Operation(summary = "Отримати список всіх водіїв")
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "Водія не знайдено"),
            @ApiResponse(responseCode = "500", description = "Помилка: за водієм закріплена техніка")
    })
